  ...
  return (
    <div className="parentDivSignUp">
      <div className="signupPage">
        ...
        <input
          onChange={(e) => dispatch({ type: "firstName", payload: e })}
          className="inputBox"
        ...
        <input
          onChange={(e) => dispatch({ type: "lastName", payload: e })}
          className="inputBox"
          placeholder="Tiwari"
          type="text"
        />
        ...
        <input
          onChange={(e) => dispatch({ type: "signupEmail", payload: e })}
          className="inputBox"
        ...
        <input
          onChange={(e) => dispatch({ type: "signupPassword", payload: e })}
          className="inputBox"
          placeholder="**************"
          type="password"
        />
        ...
        <input
          onChange={(e) => dispatch({ type: "signupRePassword", payload: e })}
          className="inputBox"
          placeholder="**************"
          type="password"
        />
        ...
        <button className="buttonLogin" onClick={signUpDetails}>
          Create New Account
        </button>

        <Link className="createNewAccount" to="/login">
