  ...
  return (
    <div className="profilePage">
      <div className="headings">
        <h1
          style={{
            color: showProfile ? "rgb(255, 207, 35)" : "rgb(253, 253, 253)",
            padding: showProfile ? "12px 95px" : "10px 70px",
          }}
          className="one"
        ...
        <h1
          style={{
            color: showAddress ? "rgb(255, 207, 35)" : "rgb(253, 253, 253)",
            padding: showAddress ? "12px 95px" : "10px 70px",
          }}
          className="two"
      ...
      <div>
        ...
        >
          <div className="profileInfo">
            <p>
              {" "}
              <b> Account Holder -</b> {state?.firstName} {state?.lastName}
            </p>
            <p>
              {" "}
              <b> Email Address -</b> {state?.loginEmail}
            </p>
          </div>
