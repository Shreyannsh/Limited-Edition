      ...
      <div className="filters-category">
        ...
        <label>
          <input
            ...
            type="checkbox"
            name="category"
            checked={state.checkBoxValues.includes("laptop")}
          />{" "}
          Laptop
        </label>
        <label>
          <input
            ...
            type="checkbox"
            name="category"
            checked={state.checkBoxValues.includes("phones")}
          />{" "}
          Phone
        </label>
        <label>
          <input
            ...
            type="checkbox"
            name="category"
            checked={state.checkBoxValues.includes("watches")}
          />{" "}
          Watches
        </label>
        <label>
          <input
            ...
            type="checkbox"
            name="category"
            checked={state.checkBoxValues.includes("earbuds")}
          />{" "}
          Earbuds
        </label>
        <label>
          <input
            ...
            type="checkbox"
            name="category"
            checked={state.checkBoxValues.includes("gadgets")}
          />{" "}
          Gadgets
        </label>
      </div>
      ...
      <div className="filters-sort">
        ...
        <label>
          <input
            ...
            value="highToLow"
            onChange={(e) =>
              dispatch({ type: "filterBySort", payload: e.target.value })
            }
