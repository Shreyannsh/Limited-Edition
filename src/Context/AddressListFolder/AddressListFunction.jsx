...
export const AddressListFunction = (propps) => {
  ...
  const { dispatch, addressList, removeAddress, setSelectedAddress_Id } =
  ...
  return (
    <div>
      {addressList.map((address) => (
        <li key={address._id} className="addressComponent">
          <label>
            <div>
              <input
                type="radio"
                name="address"
                value={address._id}
                onChange={(e) => setSelectedAddress_Id(e.target.value)}
              />
            </div>
            ...
            <button className="addressBtn" onClick={() => update_btn(address)}>
              Update
            </button>
            <button
      ...
      <button className="addBtn" onClick={() => add_btn()}>
        {" "}
        + Add New Address
      </button>
      <AddAddress
